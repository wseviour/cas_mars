...
c*********************************************************************
      ...
      implicit none
c
c returns the total number of starts that have been
c initiated on timer timer_id.
c
c**********************************************************************
      integer timer_id
      include "timer.h"
...
c**********************************************************************
c
c return the total number of starts on timer timer_id
c
      timer_calls = timer_starts(timer_id)
c**********************************************************************
      return
      end
