...
def cube_from_BOB(run_dir, vars, res, time_step=0.25,units=None):
    ...
    tmp = np.rad2deg(np.genfromtxt('../grids/GRID.T%s' % res, max_rows=nlat/2)[:,1])
...
if __name__ == '__main__':
    ...
    PATH = '../output/ann57.-70.-nu4-urlx-kt4.0-sinlat.c-0020.T85'
    res = 85

    ds = cube_from_BOB(PATH, ['q','u','v','h','s'], 85, time_step=0.5)
