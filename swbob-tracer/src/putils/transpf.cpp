...
c
c...multinode.h:: common for multinode 1  latitude decomposition
c
      integer  rank       ! node id
      ...
      integer  sum_op     ! sum reduce operation
      integer  max_op     ! max reduce operation
      common /multinode/ rank,root,comm,
     .     real_t,int_t,char_t,pack_t,bool_t,stat_s,sum_op,max_op


c
c...arguments
c
      integer  len      ! length of each slice
      integer  p        ! # of spectral processors
      integer  n        ! # of processors
      real*8  fc(len,0:p-1)    ! input array
      real*8  fcx(len,0:n-1)   ! output array
c
c...local variables      
c
      integer  i
...
!	RBD/NJN
!
!	$Id: transpf.cpp,v 1.1.1.1 2000/11/21 02:06:23 rivier Exp $
!
!	Function:	- 1  F77 header file
!
...
!
       ...
       integer MPI_MAX_NAME_LEN, MPI_MAX_OBJECT_NAME
